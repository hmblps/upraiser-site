...
/**
 * MagicUI Animated Beam — SVG path with traveling gradient between two nodes.
...
export function AnimatedBeam({
  ...
  duration = 4,
  delay = 0,
  pathColor = "var(--theme-border)",
  pathWidth = 2,
  pathOpacity = 0.35,
  gradientStartColor = "var(--theme-accent)",
  gradientStopColor = "var(--theme-accent-secondary)",
  startXOffset = 0,
  startYOffset = 0,
  endXOffset = 0,
  endYOffset = 0,
