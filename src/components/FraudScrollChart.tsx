...
const fraudGhostLayout = [
  { left: "48%", mobileLeft: "15%", originY: 79, mobileOriginY: 86, drift: 16, duration: 7.2, delay: 0 },
  { left: "63%", mobileLeft: "40%", originY: 85, mobileOriginY: 92, drift: -12, duration: 7.8, delay: 1.1 },
  { left: "78%", mobileLeft: "65%", originY: 75, mobileOriginY: 82, drift: 14, duration: 8.1, delay: 2.0 },
  { left: "92%", mobileLeft: "85%", originY: 81, mobileOriginY: 88, drift: -10, duration: 6.6, delay: 2.8 },
] as const;
...
function FraudGhost({ 
  ...
  const finalOriginY = isMobile ? layout.mobileOriginY : layout.originY;
