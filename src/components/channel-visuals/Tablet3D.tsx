...
const MODEL_PATH = "/channels/oem/tablet.glb";
...
function TabletMesh({
  ...
  return (
    <group ref={group}>
      <Center>
        <group rotation={[Math.PI / 2, 0, 0]} scale={35} position={[0, -0.3, 0]}>
...
export function Tablet3D({ mode, className }: Tablet3DProps) {
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Interactive Tablet mockup — drag to rotate"
